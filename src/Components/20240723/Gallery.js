...
export function Gallery() {
  ...
  useEffect(() => {
    setState("none");
    console.log("page useEffect", state);
  }, [page]);
  ...
  return (
    <>
      <Container>
        ...
        <h4>
          {page} of {sculptureList.length}
          <button onClick={minus} style={{ marginLeft: "20px" }}>
            Prev
          </button>
          <button onClick={plus} style={{ marginLeft: "20px" }}>
            Next
          </button>
        </h4>
        <Box>
